    ...
    <>
          ...
          <IconButton
            ...
            onClick={() =>
              openModal(
                {
                  ...selectedHero,
                  date_of_birth: formatDate(selectedHero?.date_of_birth!),
                },
                true
              )
            }
            sx={{
              "&.MuiButtonBase-root": {
                color:
                  !selectedHero || !selectedHero.is_active ? "gray" : "inherit",
              },
            }}
          >
            <BorderColorOutlinedIcon
              sx={{
                color:
                  !selectedHero || !selectedHero.is_active ? "gray" : "primary",
              }}
            />
          </IconButton>
        </MenuItem>
      ...
      <ConfirmModal
        ...
        message={
          selectedHero
            ? !selectedHero.is_active
              ? `Tem certeza que deseja reativar o herói "${selectedHero.nickname}"?`
              : `Tem certeza que deseja inativar o herói "${selectedHero.nickname}"?`
            : "Nenhum herói selecionado."
        }
        onConfirm={
          !selectedHero?.is_active
            ? handleConfirmReativate
            : handleConfirmDelete
        }
